...
public class TaskManagerServiceTest {
    ...
    void testAddTaskAndReturnTask() {
        ...
        Task task = new WorkTask(uuid, "Work Task Title", "Work Task Description", new Date(), "Project Name", TaskType.WORK);
        ...
        assertEquals("Work Task Title", tasks.get(0).getTitle(), "Task title should be the same.");
    }
